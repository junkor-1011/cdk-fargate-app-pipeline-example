  ...
  it('verifies successful response', async () => {
    const event: APIGatewayProxyEvent = {
      ...
      requestContext: {
        ...
        path: '/lambda-authorizer-test/hello-accept',
        protocol: 'HTTP/1.1',
        requestId: 'c6af9ac6-7b61-11e6-9a41-93e8deadbeef',
        requestTimeEpoch: 1428582896000,
        resourceId: '123456',
        resourcePath: '/lambda-authorizer-test/hello-accept',
        stage: 'dev',
      },
      resource: '',
      stageVariables: {},
    ...
    expect(JSON.parse(result.body).message).toBe('accept lambda example');
  });
});
